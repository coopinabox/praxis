...
var Edge = module.exports = sql.Model.extend({
  ...
  search: function (to, from) {
    ...
    //
    // in other words,
    // returns all edges where :to is in this.get(:from), recursively.
    ...
    return searchStep([this.get(from)]);
  },
  predecessors: function () {
    ...
    return this.search('targetId', 'sourceId');
  },
  successors: function () {
    ...
    return this.search('sourceId', 'targetId');
  },
