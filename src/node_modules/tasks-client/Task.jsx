  ...
  return (
    <section>
      <form role="form" className="task-form">
        ...
        <div className={"name-group form-group" + ((this.state.errors.name) ? " has-error" : "")}>
        ...
        <div className={"description-group form-group" + ((this.state.errors.description) ? " has-error" : "")}>
